...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        abc = AppBarConfiguration(
            setOf(R.id.homeFragment, R.id.page1Fragment, R.id.page2Fragment, R.id.page3Fragment), binding.drawerLayout
        )
        ...
        binding.navView.menu.findItem(R.id.custom).setOnMenuItemClickListener {
            Snackbar.make(binding.root, "Hello from Drawer", Snackbar.LENGTH_SHORT).show()
    ...
    override fun onOptionsItemSelected(item: MenuItem): Boolean {
        ...
        when (item.itemId) {
            R.id.custom -> {
                ...
                return true //Stop passing to next level
            }
        }
